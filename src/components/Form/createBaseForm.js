        ...
        const Form = createReactClass({
                ...
                if ('initialValue' in fieldOption) {
                    if(fieldMeta.key !== fieldOption.key){
                        ...
                        if(fieldMeta.initialValue && typeof fieldMeta.initialValue === 'object'){
                            if('labelKey' in fieldOption.initialValue){
                                fieldOption.refreshMark = fieldOption.initialValue['labelKey']  !== fieldMeta.initialValue['labelKey'];
                            }
                        } else {
                            fieldOption.refreshMark = true;
                        }
            ...
            setFieldsValue(changedValues, callback) {
                ...
                const newFields = Object.keys(values).reduce((acc, name) => {
                    ...
                    if (isRegistered && isRegistered.virtual) {
